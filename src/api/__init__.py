...
from .routes import auth, user, printer, file, print, transaction, telegram, refund, stats, group, recharge_request, collections, expense, inventory, product
...
router.include_router(recharge_request.router, prefix="/recharge-requests", tags=["recharge-requests"])
